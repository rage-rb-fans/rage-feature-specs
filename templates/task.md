...
Record compatibility requirements, invariants, rejected alternatives, and details that must not be changed during implementation.

## Acceptance criteria

- [ ] Describe one observable or testable outcome.
- [ ] Describe another observable or testable outcome.
